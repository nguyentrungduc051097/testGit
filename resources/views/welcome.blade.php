        ...
        <div class="container">
            <div class="ht-left">
                <div class="mail-service">
                    ...
                    nguyentrungduc051097@gmail.com
                </div>
            ...
            <div class="ht-right">
                ...
                <div class="lan-selector">
                    <select class="language_drop" name="countries" id="countries" style="width:300px;">
                        <option value='yt' data-image="{{ asset('Template/img/flag-1.jpg') }}" data-imagecss="flag yt"
                                data-title="English">English</option>
                        <option value='yu' data-image="{{ asset('Template/img/flag-2.jpg') }}" data-imagecss="flag yu"
                            ...
                            <div class="cart-hover">
                                <div class="select-items">
                                    <table>
                                        <tbody>
                                        <tr>
                                            <td class="si-pic"><img src="{{ asset('Template/img/select-product-1.jpg') }}" alt=""></td>
                                            <td class="si-text">
                                        ...
                                        <tr>
                                            <td class="si-pic"><img src="{{ asset('Template/img/select-product-2.jpg') }}" alt=""></td>
                                            <td class="si-text">
                                                <div class="product-selected">
                                                    <p>₫60.00 x 1</p>
                                                    <h6>Kabino Bedside Table</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('Template/img/select-product-1.jpg') }}" alt="">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('Template/img/select-product-3.jpg') }}" alt="">
                                    <div class="icon">
                                        <i class="icon_heart_alt"></i>
                                    </div>
                                    <ul>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('Template/img/select-product-4.jpg') }}" alt="">
                                    <div class="icon">
                                        <i class="icon_heart_alt"></i>
                                    </div>
                                    <ul>
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="product-item">
                                <div class="pi-pic">
                                    <img src="{{ asset('Template/img/select-product-5.jpg') }}" alt="">
                                    <div class="icon">
                                        <i class="icon_heart_alt"></i>
                                    </div>
                                    <ul>
